function showTime() { 
	...
	var startDate = new Date(2017, 06, 08);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear SuSu:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----xiaohuihui   2017-10-17</c>";
